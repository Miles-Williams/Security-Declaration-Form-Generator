...
Public Class F_Main
    ...
    Private Sub EH_LoginSuccess() Handles LoginForm.LoginSuccess
        ...
        lblIssuedByValue.Text = Me.AppState.VolatileState.CurrentUser.FullName
    End Sub
...
Clear:
    ...
    Private Sub EH_CreateConsignment() Handles Me.CreateConsignment
        If lstConsignments.Items.Count <> 0 Then
            Me.AppState.VolatileState.FirstConNumber = lstConsignments.Items.Item(0)
            Me.AppState.VolatileState.ConNumbers = CreateConNumString(lstConsignments.Items)
            Me.AppState.PaperCopies = txtPaperCopies.Text
            Me.AppState.StickerCopies = txtStickerCopies.Text
